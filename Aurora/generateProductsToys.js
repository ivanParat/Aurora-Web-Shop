...
async function processData() {
   try {
      ...
      productCardFeaturedProducts.querySelector('.imageContainer').querySelector('.productImage').src=groupedProducts.Toys[0].imageSrc;
      productCardFeaturedProducts.querySelector('.productBrand').innerHTML=groupedProducts.Toys[0].brand;
      productCardFeaturedProducts.querySelector('.productName').innerHTML=groupedProducts.Toys[0].name;
      productCardFeaturedProducts.querySelector('.priceAndCartContainer').querySelector('.productPrice').innerHTML="€"+groupedProducts.Toys[0].price;

      //setting the product values to the productCard already inside of newArrivalsContainer
      productCardNewArrivals.querySelector('.imageContainer').querySelector('.productImage').src=groupedProducts.Toys[8].imageSrc;
      productCardNewArrivals.querySelector('.productBrand').innerHTML=groupedProducts.Toys[8].brand;
      productCardNewArrivals.querySelector('.productName').innerHTML=groupedProducts.Toys[8].name;
      productCardNewArrivals.querySelector('.priceAndCartContainer').querySelector('.productPrice').innerHTML="€"+groupedProducts.Toys[8].price;
